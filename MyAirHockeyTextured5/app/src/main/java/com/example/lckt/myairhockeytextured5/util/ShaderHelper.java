...
***/
package com.example.lckt.myairhockeytextured5.util;
...
public class ShaderHelper {
    ...
    public static int buildProgram(String vertexShaderSource,
        ...
        // compile the shaders
        int vShader = compileVertexShader(vertexShaderSource);
        int fShader = compileFragmentShader(fragmentShaderSource);
