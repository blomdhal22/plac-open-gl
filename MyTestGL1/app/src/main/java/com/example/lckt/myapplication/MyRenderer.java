...
***/
package com.example.lckt.myapplication;

import android.content.Context;
import android.opengl.GLSurfaceView.Renderer;

import com.example.lckt.myapplication.util.LoggerConfig;
import com.example.lckt.myapplication.util.ShaderHelper;
import com.example.lckt.myapplication.util.TextResourceReader;
    ...
    public MyRenderer(Context context) {
        ...
        float[] tableVerticesWithTriangles = {   
            ...
            -0.5f, -0.7f, 0f,   1f, 0.7f, 0.7f, 0.7f,            
             0.5f, -0.7f, 0f,   1f, 0.7f, 0.7f, 0.7f,
             0.5f,  0.7f, 0f,   2f, 0.7f, 0.7f, 0.7f,
            -0.5f,  0.7f, 0f,   2f, 0.7f, 0.7f, 0.7f,
            -0.5f, -0.7f, 0f,   1f, 0.7f, 0.7f, 0.7f,            
